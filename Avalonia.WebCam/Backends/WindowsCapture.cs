...
namespace Avalonia.WebCam.Backend
{
    ...
    public interface ICameraBackend
    {
        ...
        IVideoFormat[] GetAvailableVideoFormats
    }
    ...
    internal class WindowsCapture
    {
        ...
        internal class PropertyItems
        {
            public PropertyItems(DirectShow.IBaseFilter vcap_source)
            {
                ...
                this.CameraControl = Enum.GetValues(typeof(DirectShow.CameraControlProperty))
                ...
                this.VideoProcAmp = Enum.GetValues(typeof(DirectShow.VideoProcAmpProperty))
        ...
        private static Bitmap BufferToBitmap(byte[] buffer, int width, int height, int stride)
        {
            ...
            var result = new WriteableBitmap(new PixelSize(width, height), new Vector(dpi, dpi),
                Platform.PixelFormat.Bgra8888, Platform.AlphaFormat.Premul);
        ...
        {
            return new WriteableBitmap(new PixelSize(width, height), new Vector(96, 96), Platform.PixelFormat.Bgra8888,
    ...
    internal static class DirectShow
    {
        ...
        public interface IMediaSample
        {
            ...
            int SetTime([In, MarshalAs(UnmanagedType.LPStruct)]
                UInt64 pTimeStart, [In, MarshalAs(UnmanagedType.LPStruct)]
                UInt64 pTimeEnd);
        ...
        public interface ICreateDevEnum
        {
            int CreateClassEnumerator([In] ref Guid pType,
                [In, Out] ref System.Runtime.InteropServices.ComTypes.IEnumMoniker ppEnumMoniker, [In] int dwFlags);
        }
        ...
        [ComVisible(false)]
        internal enum FILTER_STATE : int
        {
            Stopped = 0,
            Paused = 1,
            Running = 2,
